...
const char* ssid = "INTELBRAS - JOAO"; /* coloque aqui o nome da rede wi-fi que o ESP32 deve se conectar */
const char* password = "jps510123"; /* coloque aqui a senha da rede wi-fi que o ESP32 deve se conectar */
